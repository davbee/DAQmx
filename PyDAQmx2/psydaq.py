...
10. **Error Logging**:
    ...
    - Captures and logs errors during acquisition, file saving, and database archiving.
...
- Python libraries: PySide6, PyQtGraph, PyDAQmx, numpy, csv, datetime, os, time, sqlite3.
...
5. After acquisition, the data is saved to a CSV file and archived in an SQLite3 database.
...
class DAQApp(QMainWindow):
    def __init__(self):
        ...
        self.loop_count_input.setText("101")  # Default loop count
    ...
    def run_acquisition(self, loop_count):
        ...
        try:
            ...
            for i in range(loop_count):
                ...
                self.log_message(
                    f"Iteration {i+1}/{loop_count}: Time={current_time:.3f}s, "
                ...
                time.sleep(0.05)  # Simulate 50ms delay between iterations
